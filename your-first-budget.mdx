...
<AccordionGroup>
  <Accordion icon="github" title="Income">
  ...
  <Accordion icon="rectangle-terminal" title="Primary recurring transactions">
  ...
  <Accordion icon="rectangle-terminal" title="Secondary recurring transactions">
  ...
  <Accordion icon="rectangle-terminal" title="Individual transactions">
